...
sr.reveal('.home-perceverant-text-wrapper', { duration: 2000, origin: 'bottom', viewFactor: 0.6, reset: false , scale:1.5});

sr.reveal('.home-revolution-text-wrapper', { duration: 2000, origin: 'bottom', viewFactor: 0.4, reset: false , scale:1.2});
